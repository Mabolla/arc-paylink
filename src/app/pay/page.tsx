...
export default async function PayPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  try {
    ...
    return <main><nav className="topbar"><Link className="brand" href="/"><span className="brand-mark">A</span>Arc PayLink <sup>v3.1</sup></Link></nav><div className="empty-state"><p className="eyebrow">Invalid link</p><h1>This payment request is incomplete.</h1><Link className="primary-button" href="/">Create a new request</Link></div></main>;
  }
  return (
    <main>
